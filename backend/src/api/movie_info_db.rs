...
use actix_web::{get, web::Data, web::Json, web::Path, Responder, Result, HttpResponse};
use serde::Serialize;
...
async fn movie_detail(
    ...
    let mut epilist = vec![];
    epilist.push(MovieInfoEpi {uuid:"abcd".to_string(), epi: 1, changed: 1,title: "tit".to_string(), description: "le".to_string(), thumb: "https://prod-ripcut-delivery.disney-plus.net/v1/variant/disney/D62F35AB392E56542D9E7F541B55F2E79D75B95ADE5F1578BD91FC5A7959CA83/scale?width=400&aspectRatio=NaN&format=jpeg".to_string(), progress: 27});
    epilist.push(MovieInfoEpi {uuid: "efgh".to_string(), epi: 2, changed: 2,title: "tit".to_string(), description: "le".to_string(), thumb: "https://prod-ripcut-delivery.disney-plus.net/v1/variant/disney/D62F35AB392E56542D9E7F541B55F2E79D75B95ADE5F1578BD91FC5A7959CA83/scale?width=400&aspectRatio=NaN&format=jpeg".to_string(), progress: 27});
